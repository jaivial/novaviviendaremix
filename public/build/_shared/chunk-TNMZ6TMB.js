...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id3 = (0, import_react2.default).useId();
...
var $ea8dcbcb9ea1b556$var$RouterContext = /* @__PURE__ */ (0, import_react8.createContext)({
  isNative: true,
...
function $ea8dcbcb9ea1b556$export$323e4fc2fa4753fb(props) {
  ...
  return /* @__PURE__ */ (0, import_react8.default).createElement($ea8dcbcb9ea1b556$var$RouterContext.Provider, {
    value: ctx
  }, children);
}
...
function $ef06256079686ba0$export$f8aeda7b10753fa1(description) {
  let [id3, setId] = (0, import_react10.useState)();
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    if (!description)
      return;
...
function $458b0a5536c1a7cf$export$40bfa8c7b0832715(value, defaultValue, onChange) {
  let [stateValue, setStateValue] = (0, import_react12.useState)(value || defaultValue);
  let isControlledRef = (0, import_react12.useRef)(value !== void 0);
  ...
  let setValue = (0, import_react12.useCallback)((value2, ...args) => {
...
var $f57aed4a881a3485$var$Context = /* @__PURE__ */ (0, import_react13.default).createContext(null);
function $f57aed4a881a3485$export$178405afcd8c5eb(props) {
  let { children } = props;
  let parent = (0, import_react13.useContext)($f57aed4a881a3485$var$Context);
  let [modalCount, setModalCount] = (0, import_react13.useState)(0);
  ...
  return /* @__PURE__ */ (0, import_react13.default).createElement($f57aed4a881a3485$var$Context.Provider, {
    value: context
  }, children);
}
function $f57aed4a881a3485$export$d9aaed4c3ece1bc0() {
  let context = (0, import_react13.useContext)($f57aed4a881a3485$var$Context);
  return {
    modalProviderProps: {
...
function $f57aed4a881a3485$var$OverlayContainerDOM(props) {
  ...
  return /* @__PURE__ */ (0, import_react13.default).createElement("div", {
...
function $f57aed4a881a3485$export$bf688221f59024e5(props) {
  return /* @__PURE__ */ (0, import_react13.default).createElement($f57aed4a881a3485$export$178405afcd8c5eb, null, /* @__PURE__ */ (0, import_react13.default).createElement($f57aed4a881a3485$var$OverlayContainerDOM, props));
}
...
"use client";
var PresenceContext = (0, import_react14.createContext)(null);
...
function usePresence() {
  ...
  (0, import_react15.useEffect)(() => register(id3), []);
  const safeToRemove = (0, import_react15.useCallback)(() => onExitComplete && onExitComplete(id3), [id3, onExitComplete]);
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react18.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
// node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs
var useIsomorphicLayoutEffect = isBrowser2 ? import_react21.useLayoutEffect : import_react21.useEffect;
...
function useVisualElement(Component2, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const visualElementRef = (0, import_react23.useRef)();
...
function useCreateMotionContext(props) {
  const { initial, animate } = getCurrentTreeVariants(props, (0, import_react25.useContext)(MotionContext));
  return (0, import_react25.useMemo)(() => ({ initial, animate }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate)]);
}
...
function createRendererMotionComponent({ preloadedFeatures, createVisualElement, useRender, useVisualState, Component: Component2 }) {
  ...
  const ForwardRefMotionComponent = (0, import_react26.forwardRef)(MotionComponent);
...
function useSVGProps(props, visualState, _isStatic, Component2) {
  const visualProps = (0, import_react30.useMemo)(() => {
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component2 !== import_react31.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
    const { children } = props;
    const renderedChildren = (0, import_react31.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
    return (0, import_react31.createElement)(Component2, {
      ...elementProps,
...
var createDomVisualElement = (Component2, options) => {
  return isSVGComponent(Component2) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component2 !== import_react32.Fragment
  });
};
...
function LazyMotion({ children, features, strict = false }) {
  ...
  return (0, import_jsx_runtime3.jsx)(LazyContext.Provider, { value: { renderer: loadedRenderer.current, strict }, children });
}
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react36.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
var LayoutGroup = ({ children, id: id3, inherit = true }) => {
  const layoutGroupContext = (0, import_react37.useContext)(LayoutGroupContext);
  const deprecatedLayoutGroupContext = (0, import_react37.useContext)(DeprecatedLayoutGroupContext);
  const [forceRender, key] = useForceUpdate();
  const context = (0, import_react37.useRef)(null);
  ...
  const memoizedContext = (0, import_react37.useMemo)(() => ({ ...context.current, forceRender }), [key]);
...
var NextUIProvider = ({
  ...
  if (navigate) {
    contents = /* @__PURE__ */ (0, import_jsx_runtime5.jsx)($ea8dcbcb9ea1b556$export$323e4fc2fa4753fb, { navigate, useHref, children: contents });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ProviderContext, { value: context, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)($18f2051aff69b9bf$export$a54013f0d02a8f82, { locale, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)($f57aed4a881a3485$export$bf688221f59024e5, { ...otherProps, children: contents }) }) });
};

// node_modules/@nextui-org/system-rsc/dist/chunk-DRE2DOBH.mjs
var import_react39 = __toESM(require_react(), 1);
function forwardRef2(component) {
  return (0, import_react39.forwardRef)(component);
}
...
//# sourceMappingURL=/build/_shared/chunk-TNMZ6TMB.js.map
